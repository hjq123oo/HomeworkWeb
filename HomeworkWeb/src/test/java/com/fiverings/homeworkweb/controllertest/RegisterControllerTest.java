...
public class RegisterControllerTest {
	...
	public void testRegisterTeacher() throws Exception {
		...
		mockMvc.perform((post("/registerTeacher").param("name","ggf").param("pwd", "123").param("school", "北京交通大学")
				.param("teacherNO", "abc123").param("email", "123@qq.com")
				.param("phone", "18813091234").param("realname", "黄坚"))).andDo(print());
	...
	public void testRegisterStudent() throws Exception {
		...
		mockMvc.perform((post("/registerStudent").param("name","hjq").param("pwd", "123").param("school", "北京交通大学")
