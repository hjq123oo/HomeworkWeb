	...
	<body>
		<div id="nav">
			...
			<div id="navarea">
				...
				<ul id="navs">
					<li class="navItem"><a href="courseCenter"><span>首页</span></a></li>
						...
						<div id = "personalInfoForm">
							<table class = "infomation_table">
								<tr>
									...
									<td><input type = "text" class = "text" readonly value="" id = "tea_account"></td>
									<td><a href="modifyPwd.html">修改密码</a></td>
								</tr>
								<tr>
									<td class = "first_col">学校：</td>	
									<td><input type = "text" class = "text" readonly value="" id = "tea_school"></td>
								</tr>
								<tr>
									<td class = "first_col">工号：</td>
									<td><input type = "text" class = "text" readonly value="" id = "tea_number"></td>
								</tr>
								<tr>
									<td class = "first_col">姓名：</td>
									<td><input type = "text" class = "text" readonly value="" id = "tea_name"></td>
								</tr>
								<tr>
									<td class = "first_col">常用邮箱：</td>
									<td><input type = "text" class = "text" readonly value=""  id = "tea_email"></td>
								</tr>
								<tr>
									<td class = "first_col">联系方式：</td>
									<td><input type = "text" class = "text" readonly value=""  id = "tea_phone"></td>
								</tr>
								<tr>
									<td colspan="3">
